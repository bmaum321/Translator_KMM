...
import com.brian.translator_kmm.android.voiceToText.presentation.VoiceToTextScreen
...
fun TranslateRoot() {
    ...
    NavHost(
        ...
        composable(
            ...
            /**
             * Any time the voice result is changed, the effect will launch
             */
            LaunchedEffect(voiceResult) {
                viewModel.onEvent(TranslateEvent.SubmitVoiceResult(voiceResult))
                // After we submit the voice result we need to reset it to null
