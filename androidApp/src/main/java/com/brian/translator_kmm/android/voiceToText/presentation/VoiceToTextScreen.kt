...
import com.brian.translator_kmm.android.voiceToText.presentation.components.VoiceRecorderDisplay
import com.brian.translator_kmm.voicetotext.presentation.DisplayState
import com.brian.translator_kmm.voicetotext.presentation.VoiceToTextEvent
import com.brian.translator_kmm.voicetotext.presentation.VoiceToTextState
        ...
        onResult = { isGranted ->
            onEvent(
                VoiceToTextEvent.PermissionResult(
                    isGranted = isGranted,
                    /**
                     * Cast context to a compenet activity, if the rational returns true, permission was declined once
                     * returns true if decline twice
                     */
